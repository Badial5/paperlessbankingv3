...
// import SuccessPIN from './SuccessUnsubscribe';

import SuccessUnSubscribe from './SuccessUnsubscribe';
...
const ConfirmUnsubscribe = ({ openConfirm, handleConfirmClose, handleClose, textProps, titleProps }) => {
    ...
    <div>
      ...
      >
        <Paper sx={{ backgroundColor: '#f5f5f5', width: '30vw', maxWidth: '600px', margin: '0 auto' }}>
          <DialogTitle textAlign='center' sx={{ fontFamily: 'Poppins', backgroundColor: 'rgba(151, 71, 255, 0.5)', color: 'black', fontSize: 14 }}>{titleProps}</DialogTitle>
          <hr />
          ...
          <DialogContent>
            <DialogContentText id="alert-dialog-slide-description">
              <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <Typography sx={{ fontFamily: 'Poppins', fontSize: 10, color: 'red', fontWeight: 400 }}>
                  {textProps}
                </Typography>
              </Box>
            </DialogContentText>
      ...
      <SuccessUnSubscribe successOpen={successOpen} handleClose={handleSuccessClose} titleProps='Successfully Unsubscribe' />
    </div>
  );
}
