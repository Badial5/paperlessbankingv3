...
const ConfirmPassword = ({ openConfirm, handleConfirmClose, handleClose, textProps, titleProps }) => {
  ...
  return (
    <div>
      ...
      <GlobalSuccess successOpen={successOpen} handleClose={handleSuccessClose} titleProps='Password Update' />
    </div>
  );
}
