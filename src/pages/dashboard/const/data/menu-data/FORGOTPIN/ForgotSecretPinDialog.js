...
import ConfirmPIN from './ConfirmForgotPin';
import ConfirmForgotPIN from './ConfirmForgotPin';
...
const ForgotSecretPinDialog = ({ openDialog, handleClose, handleOpen }) => {
  ...
  return (
    <div>
        ...
        <Paper sx={{ backgroundColor: '#f5f5f5', width: '30vw', maxWidth: '600px', margin: '0 auto' }}>
          ...
          <DialogContent>
            <Grid container sx={{ padding: 5, rowGap: 2 }}>
              ...
              <Grid item xs={12}>
                <GlobalInputLabel htmlFor='current_password'>Enter New PIN</GlobalInputLabel>
                <GlobalTextField id='current_password' fullWidth/>
                </Grid>

              <Grid item xs={12}>
                <GlobalInputLabel htmlFor='new_password'>Confirm PIN</GlobalInputLabel>
      ...
      <ConfirmForgotPIN openConfirm={confirmOpen} handleConfirmClose={handleConfirmClose} handleClose={ handleClose} textProps="Are You Sure you want to update your PIN?" titleProps="Change PIN" /> {/* Render GlobalConfirm dialog */}
    </div>
  );
}

export default ForgotSecretPinDialog;
