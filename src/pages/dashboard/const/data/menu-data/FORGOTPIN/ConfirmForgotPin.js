...
// import SuccessPIN from './SuccessForgotPin';
import SuccessForgotPIN from './SuccessForgotPin';
...
const ConfirmForgotPIN = ({ openConfirm, handleConfirmClose, handleClose, textProps, titleProps }) => {
  ...
  return (
    <div>
      ...
      <SuccessForgotPIN successOpen={successOpen} handleClose={handleSuccessClose} titleProps='PIN Updated' />
    </div>
  );
}

export default ConfirmForgotPIN;
