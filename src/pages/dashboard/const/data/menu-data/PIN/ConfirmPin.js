...
const ConfirmPIN = ({ openConfirm, handleConfirmClose, handleClose, textProps, titleProps }) => {
  ...
  return (
    <div>
      ...
      <SuccessPIN successOpen={successOpen} handleClose={handleSuccessClose} titleProps='PIN Update' />
    </div>
  );
}
