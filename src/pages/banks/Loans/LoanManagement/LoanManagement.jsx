  ...
  return (
    <DashboardPageBackground >
      <DashboardPaper
       sx={{ mb: 20}}>
        <GlobalPageHeader>
        Loan Management - Snap Cash Repayment
        </GlobalPageHeader>
        <GlobalSubPageHeader>
        Effortless Repayment: Snap Cash Loan Management
        </GlobalSubPageHeader>
        ...
        <GlobalInputLabel sx={{}}>Your Secret Pin <span style={{color: "red"}}>*</span> </GlobalInputLabel>
        </Grid>
