...
const MyLoan = () => {
    ...
    const columns = [
        ...
        { field: 'contractNumber', headerName: 'Contract Number', width: 120 },

        { field: 'loanType', headerName: 'Loan Type', width: 80},
    ...
    <DashboardPageBackground>
      <DashboardPaper
       sx={{width: "90%"}}>
        ...
        <GlobalSubPageHeader>
        Empowering Your Financial Future: Unlocking Opportunities with Our Loan Services
        </GlobalSubPageHeader>
