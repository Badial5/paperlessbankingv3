...
sx={{width: "30rem", display: "flex", padding: "30px 30px", borderRadius: 10 }}> */}
      ...
      <Grid container spacing={0} style={{
        ...
        // m: 5, 
        mb: 10 }}>
          <PageHeader2>Request - Register Mobile Banking</PageHeader2>
          <SubTitle2 sx={{fontSize: {xs: 8, md: 10, lg: 12, marginTop: 5 }}}>
          Securely Access Your Accounts Anytime, Anywhere with Mobile Banking Registration
          </SubTitle2>
...
<Grid item xs={3}sx={{mt: 1.5}} >
        ...
        <NameLabel sx={{}}>Phone Number <span style={{color: "red"}}>*</span></NameLabel>
</Grid>
...
export default RegisterMobileBanking;
