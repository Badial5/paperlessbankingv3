...
//Pages
import RegisterMobileBanking from './steps/register-mobile-banking';
import RMMConfirmation from './steps/RMMConfirmation';
...
const steps = ['Register MobileMoney',  'Confirmation'];


const RMMFormContainer = () => {
  ...
  const handleChange = input => e => {
   ...
   const renderStepContent = (step) => {
    switch (step) {
      case 0:
        return <RegisterMobileBanking formData={formData} handleNext={handleNext} handleChange={handleChange} register={register} isValid={isValid} errors={errors}  />;

        
      case 1:
        return <RMMConfirmation formData={formData} handleNext={handleNext} handleBack={handleBack} handleChange={handleChange} reset={reset} trigger={trigger} setValue={setValue}  handleSubmit={handleSubmit} register={register} isValid={isValid} errors={errors}
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      <DashboardPageBackground>
        ...
        <DashboardPaper elevation={20} sx={{width: '30rem', height: 'auto'}}>
...
export default RMMFormContainer
