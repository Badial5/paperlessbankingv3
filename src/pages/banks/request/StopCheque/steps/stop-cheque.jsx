...
const numberOfCopies = [
  ...
  const reasonMode = [
    {value: "", label: "----------Select--------------"},
    { value: "chequeLost", label: "Cheque Lost" },
    { value: "chequeDestroyed", label: "Cheque Destroyed" },
    { value: "chequeStolen", label: "Cheque Stolen" },
    { value: "paymentStoppedByCustomer", label: "Payment Stopped By Customer" },
    { value: "clonedCheque", label: "Cloned Cheques" },
    { value: "staleCheque", label: "Stale Cheque" },
  ]
...
//   Form states 
  const [value1, setValue1] = useState("");
    ...
    const handleChequeType = (e) => {
      setChequeTypeState(e.target.value)
    }
...
sx={{width: "30rem", display: "flex", padding: "10px 30px", borderRadius: 10 }}>
   */}
      <Grid container spacing={0} style={{
        ...
        // m: 5, 
        mb: 10 }}>
          <PageHeader2>Request - Stop Cheque</PageHeader2>
          <SubTitle2 sx={{fontSize: {xs: 8, md: 10, lg: 12, marginTop: 5 }}}>
          Request a Stop Cheque and Prevent Unauthorized Transactions
          </SubTitle2>
...
<Grid item xs={3}sx={{mt: 1.5}} >
        ...
        <NameLabel sx={{}}>Reason <span style={{color: "red"}}>*</span></NameLabel>
        </Grid>
    ...
    >
      {reasonMode.map((option) => (
        ...
        <NameLabel sx={{}}>Cheque Type  <span style={{color: "red"}}>*</span></NameLabel>
        </Grid>
    ...
    <TextField
      id="cheque_type"
      fullWidth
      error={Boolean(errors.cheque_type)}
      variant="outlined"
      ...
      value={chequeTypeState}
      onChange={handleChequeType}
    >
      {chequeTypeMode.map((option) => (
        <MenuItem key={option.value} value={option.value}>
          {option.label}
        </MenuItem>
      ))}
        ...
        <NameLabel sx={{}}>Charge Account <span style={{color: "red"}}>*</span> </NameLabel>
</Grid>
...
<Grid item xs={3}sx={{mt: 1.5}} >
        ...
        <NameLabel sx={{}}>First Cheque Number <span style={{color: "red"}}>*</span></NameLabel>
</Grid>
...
<Grid item xs={9} sx={{display: "flex"}} >
    ...
    <TextField
      id="first_cheque"
      fullWidth
      error={Boolean(errors.first_cheque)}
      variant="outlined"
      ...
      {...register("first_cheque", {
        required: {
          value: true,
          message: "First Cheque Number is required"
        }
      })}
      // label="Branch"
      placeholder="First Cheque Number"
      value={firstChequeState}
      onChange={handleFirstCheque}
