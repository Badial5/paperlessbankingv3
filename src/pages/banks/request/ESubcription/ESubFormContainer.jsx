...
//Pages
import ESubcriptionAlert from './steps/e-subscription-alert';
import ESubConfirmation from './steps/ESubConfirmation';
...
const steps = ['E-Subscription',  'Confirmation'];


const ESubFormContainer = () => {
  ...
  const handleChange = input => e => {
   ...
   const renderStepContent = (step) => {
    switch (step) {
      case 0:
        return <ESubcriptionAlert formData={formData} handleNext={handleNext} handleChange={handleChange} register={register} isValid={isValid} errors={errors}  />;

        
      case 1:
        return <ESubConfirmation formData={formData} handleNext={handleNext} handleBack={handleBack} handleChange={handleChange} reset={reset} trigger={trigger} setValue={setValue}  handleSubmit={handleSubmit} register={register} isValid={isValid} errors={errors}
...
export default ESubFormContainer
