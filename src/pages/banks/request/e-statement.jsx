...
sx={{width: "30rem", display: "flex", padding: "30px 30px", borderRadius: 10 }}>
      ...
      <Grid container spacing={0} style={{
        ...
        // m: 5, 
        mb: 10 }}>
          <PageHeader2>Request - E-Statement Subscription</PageHeader2>
          <SubTitle2 sx={{fontSize: {xs: 8, md: 10, lg: 12, marginTop: 5 }}}>
          Get your account statements conveniently delivered to your inbox with our E-Statement Subscription
          </SubTitle2>
...
export default EStatementAlert;
