...
//Pages
import ESConfirmation from './steps/ESConfirmation';
import EStatementAlert from './steps/e-statement';
...
const steps = ['E-Statement Request',  'Confirmation'];


const ESFormContainer = () => {
  ...
  const handleChange = input => e => {
   ...
   const renderStepContent = (step) => {
    switch (step) {
      case 0:
        return <EStatementAlert formData={formData} handleNext={handleNext} handleChange={handleChange} register={register} isValid={isValid} errors={errors}  />;

        
      case 1:
        return <ESConfirmation formData={formData} handleNext={handleNext} handleBack={handleBack} handleChange={handleChange} reset={reset} trigger={trigger} setValue={setValue}  handleSubmit={handleSubmit} register={register} isValid={isValid} errors={errors}
...
export default ESFormContainer
