...
//Pages
import ChequeBookRequest from './steps/cheque-book';
import CBConfirmation from './steps/CBConfirmation';
...
const steps = ['Request Cheque Book',  'Confirmation'];


const ChequeBookFormContainer = () => {
  ...
  const handleChange = input => e => {
   ...
   const renderStepContent = (step) => {
    switch (step) {
      case 0:
        return <ChequeBookRequest formData={formData} handleNext={handleNext} handleChange={handleChange} register={register} isValid={isValid} errors={errors}  />;

        
      case 1:
        return <CBConfirmation formData={formData} handleNext={handleNext} handleBack={handleBack} handleChange={handleChange} reset={reset} trigger={trigger} setValue={setValue}  handleSubmit={handleSubmit} register={register} isValid={isValid} errors={errors}
...
export default ChequeBookFormContainer
