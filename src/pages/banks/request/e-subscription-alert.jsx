...
sx={{width: "30rem", display: "flex", padding: "30px 30px", borderRadius: 10 }}>
      ...
      <Grid container spacing={0} style={{
        ...
        // m: 5, 
        mb: 10 }}>
          <PageHeader2>Request - E-Alert Subscription</PageHeader2>
          <SubTitle2 sx={{fontSize: {xs: 8, md: 10, lg: 12, marginTop: 5 }}}>
          Stay Informed with Our E-Alert Subscription Service
          </SubTitle2>
...
export default ESubcriptionAlert;
