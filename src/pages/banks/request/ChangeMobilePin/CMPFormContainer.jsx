...
//Pages
import ChangeMobilePin from "./steps/changeMobilePin"
import CMPConfirmation from './steps/CMPConfirmation';
...
const steps = ['Change Mobile Pin Confirmation',  'Confirmation'];


const CMPFormContainer = () => {
  ...
  const handleChange = input => e => {
   ...
   const renderStepContent = (step) => {
    switch (step) {
      case 0:
        return <ChangeMobilePin formData={formData} handleNext={handleNext} handleChange={handleChange} register={register} isValid={isValid} errors={errors}  />;

        
      case 1:
        return <CMPConfirmation formData={formData} handleNext={handleNext} handleBack={handleBack} handleChange={handleChange} reset={reset} trigger={trigger} setValue={setValue}  handleSubmit={handleSubmit} register={register} isValid={isValid} errors={errors}
...
export default CMPFormContainer