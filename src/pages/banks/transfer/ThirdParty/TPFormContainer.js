...
//Pages
import ConfirmTP from './step/confirmTP';
import ThirdParty from './step/thirdParty';
...
const TPFormContainer = () => {
  ...
  const handleChange = input => e => {
   ...
   const renderStepContent = (step) => {
    switch (step) {
      case 0:
        return <ThirdParty formData={formData} handleNext={handleNext} handleChange={handleChange} register={register} isValid={isValid} errors={errors}  />;
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      <DashboardPageBackground>
        ...
        <DashboardPaper elevation={20} sx={{height: "auto", width: "30rem"}}>
...
export default TPFormContainer
