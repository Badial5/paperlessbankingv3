...
sx={{width: "30rem", display: "flex", padding: "30px 30px", borderRadius: 10 }}> */}
          ...
          <GlobalPageHeader sx={{marginBottom: 5,}}>
            Transfer - Third Party Transfer
          </GlobalPageHeader>
...
<Grid item xs={3}sx={{mt: 1.5}} >
        <GlobalInputLabel sx={{}}>Source Account <span style={{color: "red"}}>*</span> 
        </GlobalInputLabel>
</Grid>
...
<Grid item xs={3}sx={{mt: 1.5}} >
        ...
        <GlobalInputLabel sx={{}}>Beneficiary <span style={{color: "red"}}>*</span></GlobalInputLabel>
</Grid>
...
<Grid item xs={3}sx={{mt: 1.5}} >
        ...
        <GlobalInputLabel sx={{}}>Payment Mode <span style={{color: "red"}}>*</span></GlobalInputLabel>
</Grid>
...

{
    paymentModeState === "inlakspaywallet" ? (
        ...
        <GlobalInputLabel sx={{}}>Wallet Number <span style={{color: "red"}}>*</span></GlobalInputLabel>
</Grid>
...
<Grid item xs={3}sx={{mt: 1.5}} >
        ...
        <GlobalInputLabel sx={{}}>Network <span style={{color: "red"}}>*</span></GlobalInputLabel>
        </Grid>


        <Grid item xs={9} sx={{display: "flex"}} >
          {/* <GlobalInputLabel >Network</GlobalInputLabel> */}
    ...
    >
      {networkMode.map((option) => (
        ...
        <GlobalInputLabel sx={{}}>Account number <span style={{color: "red"}}>*</span></GlobalInputLabel>
        </Grid>
        ...
        <GlobalInputLabel sx={{}}>Bank <span style={{color: "red"}}>*</span></GlobalInputLabel>
        </Grid>
