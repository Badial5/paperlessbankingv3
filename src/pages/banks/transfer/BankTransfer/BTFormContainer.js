...
//Pages
import BankTransfer from './step/bank.transfer';
import ConfirmBankTransfer from './step/ConfirmBankTransfer';
...
const steps = ['Bank Transfer',  'Confirmation'];
...
const BTFormContainer = () => {
  ...
  const handleChange = input => e => {
   ...
   const renderStepContent = (step) => {
    switch (step) {
      case 0:
        return <BankTransfer formData={formData} handleNext={handleNext} handleChange={handleChange} register={register} isValid={isValid} errors={errors}  />;

        
      case 1:
        return <ConfirmBankTransfer formData={formData} handleNext={handleNext} handleBack={handleBack} handleChange={handleChange} reset={reset} trigger={trigger} setValue={setValue}  handleSubmit={handleSubmit} register={register} isValid={isValid} errors={errors}
