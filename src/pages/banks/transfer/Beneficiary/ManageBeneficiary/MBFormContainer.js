...
import ConfirmMB from './step/ConfirmMB';
import ManageBeneficiary from './step/manage-beneficiary';
  ...
  const handleChange = input => e => {
   ...
   const renderStepContent = (step) => {
    switch (step) {
      ...
      case 0:
        return <ManageBeneficiary formData={formData} handleNext={handleNext} handleChange={handleChange} register={register} isValid={isValid} errors={errors}  />;
      ...
      case 1:
        return <ConfirmMB formData={formData} handleNext={handleNext} handleBack={handleBack} handleChange={handleChange} reset={reset} trigger={trigger} setValue={setValue}  handleSubmit={handleSubmit} register={register} isValid={isValid} errors={errors}
...
export default MBFormContainer
