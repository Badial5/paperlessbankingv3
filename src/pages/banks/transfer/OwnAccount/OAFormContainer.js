...
import ConfirmOA from './step/ConfirmOA';
import OwnAccountTransfer from './step/ownAccount';
...
const steps = ['Account Creation',  'Confirmation'];


const OAFormContainer = () => {
  ...
  const handleChange = input => e => {
   ...
   const renderStepContent = (step) => {
    switch (step) {
      ...
      case 0:
        return <OwnAccountTransfer formData={formData} handleNext={handleNext} handleChange={handleChange} register={register} isValid={isValid} errors={errors}  />;
      ...
      case 1:
        ...
        return <ConfirmOA formData={formData} handleNext={handleNext} handleBack={handleBack} handleChange={handleChange} reset={reset} trigger={trigger} setValue={setValue}  handleSubmit={handleSubmit} register={register} isValid={isValid} errors={errors}
...
export default OAFormContainer
