...
sx={{width: "30rem", display: "flex", padding: "30px 30px", borderRadius: 10 }}>
      ...
      <Grid container spacing={0} style={{
        ...
        // m: 5, 
        mb: 10 }}>
          <PageHeader2>Card Services - Amend Card Limit</PageHeader2>
          <SubTitle2 sx={{fontSize: {xs: 8, md: 10, lg: 12, marginTop: 5 }}}>
          Manage Your Spending with Ease: Updating Your Card Limit
          </SubTitle2>
...
<Grid item xs={3}sx={{mt: 1.5}} >
        ...
        <NameLabel sx={{}}>Card Number<span style={{color: "red"}}>*</span> </NameLabel>
</Grid>
...
<Grid item xs={3}sx={{mt: 1.5}} >
        ...
        <NameLabel sx={{}}>ATM Amount <span style={{color: "red"}}>*</span></NameLabel>
</Grid>
...
<Grid item xs={3}sx={{mt: 1.5}} >
        ...
        <NameLabel sx={{}}>POS Amount <span style={{color: "red"}}>*</span></NameLabel>
</Grid>
...
<Grid item xs={9} sx={{display: "flex"}} >
    ...
    <TextField
      id="pos_amount"
      fullWidth
      error={Boolean(errors.pos_amount)}
      variant="outlined"
      ...
      {...register("pos_amount", {
        required: {
          value: true,
          message: "POS Amount  is required"
        }
      })}
      // label="Branch"
