...
sx={{width: "30rem", display: "flex", padding: "10px 30px", borderRadius: 10 }}>
      ...
      <Grid container spacing={0} style={{
        ...
        // m: 5, 
        mb: 10 }}>
          <PageHeader2>Card Services - Debit Card Request</PageHeader2>
          <SubTitle2 sx={{fontSize: {xs: 8, md: 10, lg: 12, marginTop: 5 }}}>
          Get easy access to your funds with our Debit Card Request service
          </SubTitle2>
...
<Grid item xs={3}sx={{mt: 1.5}} >
        ...
        <NameLabel sx={{}}>Preferred Name On Card <span style={{color: "red"}}>*</span></NameLabel>
</Grid>
...
<Grid item xs={9} sx={{display: "flex"}} >
    ...
    <TextField
      id="prefered_name"
      fullWidth
      error={Boolean(errors.prefered_name)}
      variant="outlined"
      ...
      {...register("prefered_name", {
        required: {
          value: true,
          message: "Preferred Name On Card is required"
        }
      })}
      // label="Branch"
      placeholder="Preferred Name On Card"
      value={preferedNameState}
      onChange={handlePreferedName}
