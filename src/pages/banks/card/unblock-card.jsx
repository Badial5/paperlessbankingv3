...
sx={{width: "30rem", display: "flex", padding: "30px 30px", borderRadius: 10 }}>
      ...
      <Grid container spacing={0} style={{
        ...
        // m: 5, 
        mb: 10 }}>
          <PageHeader2>Card Services - UnBlock Card</PageHeader2>
          <SubTitle2 sx={{fontSize: {xs: 8, md: 10, lg: 12, marginTop: 5 }}}>
          Regain Access to Your Funds: How to Unblock Your Card with Card Services
          </SubTitle2>
...
<Grid item xs={3}sx={{mt: 1.5}} >
        ...
        <NameLabel sx={{}}>Card <span style={{color: "red"}}>*</span> </NameLabel>
</Grid>
