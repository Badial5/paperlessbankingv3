...
const InvestmentRequestHistory = () => {
    ...
    const columns = [
        ...
        { field: 'requestType', headerName: 'Request Type', width: 140 },

        { field: 'requestDate', headerName: 'Request Date', width: 140},
  ...
  return (
    <DashboardPageBackground>
      <DashboardPaper
       sx={{width: "90%"}}>
        <GlobalPageHeader>
          My Investment Request History
        </GlobalPageHeader>
        <GlobalSubPageHeader>
        Tracking Financial Aspirations: My Investment Request Journey
        </GlobalSubPageHeader>
